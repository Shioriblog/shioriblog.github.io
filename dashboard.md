...
<main class="stats-page" id="content">
  ...
  <div id="stats-setup" class="stats-notice" hidden>
    Dashboard 页面已经准备好，但还没有连接 Cloudflare Worker。
  </div>
  <div id="stats-error" class="stats-notice stats-error" hidden></div>

  <section class="stats-summary" aria-label="统计摘要">
    <article><span>PAGE VIEWS</span><strong id="stat-views">—</strong></article>
    <article><span>VISITS</span><strong id="stat-visits">—</strong></article>
    <article><span>PAGES / VISIT</span><strong id="stat-pages-per-visit">—</strong></article>
  </section>
  ...
  <div class="stats-grid">
    <section class="stats-panel">
      <div class="stats-panel-heading"><h2>Most viewed</h2><span>VIEWS</span></div>
      <ol class="stats-list" id="stats-pages"></ol>
    </section>

    <section class="stats-panel">
      <div class="stats-panel-heading"><h2>Referrers</h2><span>VIEWS</span></div>
  ...
  <p class="stats-footnote">只显示汇总后的访问数据；这个页面本身不会计入 Cloudflare Analytics。</p>
</main>
...
<style>
  ...
  @media (max-width: 700px) {
    ...
    .stats-summary article,
    .stats-summary article:first-child { padding: 1rem 0; border-right: 0; border-bottom: 1px solid var(--line); }
